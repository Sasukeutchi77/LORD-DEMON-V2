...
const LEVELS = ["DIEU DU RIZZ ⚡","Rizz naturel","Rizz potable","Rizz en construction","Rizz = 0","Le charmeur de serpents te déconseille 🐍"]

export default async function rizz(sock, sender, args, msg, ctx = {}) {
  try {
