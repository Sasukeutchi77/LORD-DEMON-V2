...
const LEVELS = ["DARK LORD 💀","Super-vilain accompli","Vilain mineur","Antagoniste raté","Gentil malgré lui","Le chat lui fait peur"]

export default async function vilain(sock, sender, args, msg, ctx = {}) {
  try {
