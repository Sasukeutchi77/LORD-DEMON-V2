...
const LEVELS = ["100% NPC sans cerveau","NPC avancé","Semi-NPC","Indépendant","Protagonist mode","Vous êtes le héros ⚔️"]

export default async function npc(sock, sender, args, msg, ctx = {}) {
