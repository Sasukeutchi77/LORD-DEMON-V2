...
const LEVELS = ["Colosse pur","Hercule moderne","Athlète","Citoyen lambda","Mauviette","Ouvre pas les bocaux 🫙"]

export default async function force(sock, sender, args, msg, ctx = {}) {
