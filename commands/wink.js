...
const ACTIONS = ["*fait un clin d'oeil discret* 😉","*cligne de l'oeil suggestivement* 👀","*wink wink* 😏","*oh là là !* 😉💋"]

export default async function wink(sock, sender, args, msg, ctx = {}) {
  try {
