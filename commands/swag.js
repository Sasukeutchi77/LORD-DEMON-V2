...
const LEVELS = ["SWAG INFINI 🔥","Streetwear élite","Style correct","Sans style","Habille-toi mieux","Catastrophe vestimentaire"]

export default async function swag(sock, sender, args, msg, ctx = {}) {
  try {
