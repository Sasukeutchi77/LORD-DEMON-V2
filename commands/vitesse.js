...
const LEVELS = ["Flash dépasse à pied","Supersonique","Très rapide","Normal","Lent","Tortue vieillissante 🐢"]

export default async function vitesse(sock, sender, args, msg, ctx = {}) {
  try {
