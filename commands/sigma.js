...
const LEVELS = ["SIGMA ABSOLU ⛧","Mâle alpha","Bêta amélioré","NPC basique","Simp confirmé","Omega omega omega 😢"]

export default async function sigma(sock, sender, args, msg, ctx = {}) {
  try {
