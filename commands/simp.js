...
const LEVELS = ["100% Simp King","Dangereux","Modéré","Légèrement simp","Presque clean","Complètement clean ✅"]

export default async function simp(sock, sender, args, msg, ctx = {}) {
  try {
